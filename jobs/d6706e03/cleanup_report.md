# Cleanup Report — d6706e03

## Summary
- Cleaned at: `2026-05-18T21:26:43+00:00`
- Total size before: `240003401` bytes
- Public ZIP: `bundles/d6706e03_warhead_hunter_public_results.zip` (30487759 bytes)
- Archive ZIP: not created
- Files included in public ZIP: `1850`
- Archive-only files detected: `112`
- Archived copies created: `0`
- Delete candidates: `0`
- Unknown files preserved: `4`
- Downstream-used files: `1865`
- Unused files: `119`
...
- `WAR_PDB`
  ...
  - csv_reference: Results_Display.csv — Referenced by source text via 'WAR_PDB/DYRK1A/2vx3_A_D15.pdb'.
  - csv_reference: Results_Display.csv — Referenced by source text via 'WAR_PDB/DYRK1A/2vx3_B_D15.pdb'.
  - csv_reference: Results_Display.csv — Referenced by source text via 'WAR_PDB/DYRK1A/2vx3_C_D15.pdb'.
