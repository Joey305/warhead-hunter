# Cleanup Report — b281996d

## Summary
- Cleaned at: `2026-05-18T21:26:20+00:00`
- Total size before: `269061070` bytes
- Public ZIP: `bundles/b281996d_warhead_hunter_public_results.zip` (4266251 bytes)
- Archive ZIP: not created
- Files included in public ZIP: `590`
- Archive-only files detected: `182`
- Archived copies created: `0`
- Delete candidates: `0`
- Unknown files preserved: `4`
- Downstream-used files: `605`
- Unused files: `189`
...
- `WAR_PDB`
  ...
  - csv_reference: Results_Display.csv — Referenced by source text via 'WAR_PDB/CRBN/4ci1_B_EF2.pdb'.
  - csv_reference: Results_Display.csv — Referenced by source text via 'WAR_PDB/CRBN/4ci2_B_LVY.pdb'.
  - csv_reference: Results_Display.csv — Referenced by source text via 'WAR_PDB/CRBN/4ci3_B_Y70.pdb'.
