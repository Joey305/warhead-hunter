# Cleanup Report — 032917e1

## Summary
- Cleaned at: `2026-05-18T21:23:42+00:00`
- Total size before: `304982681` bytes
- Public ZIP: `bundles/032917e1_warhead_hunter_public_results.zip` (79142 bytes)
- Archive ZIP: not created
- Files included in public ZIP: `50`
- Archive-only files detected: `424`
- Archived copies created: `0`
- Delete candidates: `0`
- Unknown files preserved: `4`
- Downstream-used files: `65`
- Unused files: `432`
...
- `WAR_PDB`
  ...
  - csv_reference: Results_Display.csv — Referenced by source text via 'WAR_PDB/EGFR/2gs6_B_112.pdb'.
