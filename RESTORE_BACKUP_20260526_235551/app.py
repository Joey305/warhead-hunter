...
# JOBS_ROOT = Path(os.getenv("PROTACABLE_JOBS_ROOT", "/home/jxs794/WEBTOOLs/PROTAC-Target-Builder/jobs"))
...
# def ligand_sdf_dir(job_id: str) -> Path:
#     # wherever you store ligand SDFs for a job
#     return job_dir(job_id) / "ligands_sdf"
...
if __name__ == "__main__":
    app.run(debug=True, host="127.0.0.1", port=5069)
